...
public class Employee extends RecursiveTreeObject<Employee>{
    ...
    public Employee(int id, String first_name, String second_name, String birth_date, String phone_number, String email, String country, String state, String city, String street, String department, String position, String hire_date, Boolean has_family, String sex){
    ...
    public void setHireDate(String value){ hire_date.set(value);}
